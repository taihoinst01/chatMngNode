...
function makGrid() {
    $("#gridList").jqGrid({
        ...
        colModel: [
          ...
          {name:'REG_DT'    , label:language['REGIST_DATE'] , width:110, editable:false, align:'left', sortable:true, hidden:false},
          ...
          {name:'LAST_LOGIN_DT'    , label:language['LAST_LOGIN_DATE'], width:110, editable:false, align:'center', sortable:false, hidden:false},
          {name:'LOGIN_FAIL_CNT'    , label:language['LOGIN_FAIL_CNT'] , width:80, editable:false, align:'center', sortable:false, hidden:false},
